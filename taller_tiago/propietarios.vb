...
Public Class propietarios
    ...
    Private Sub btninsertr_Click(sender As Object, e As EventArgs) Handles btninsertr.Click
        sentencia = "insert into propietarios values('" + txtnombre.Text + "','" + txttelefono.Text + "')"
        mensaje = "Datos Insertados Correctamente"
        EjecutarSql(sentencia, mensaje)
    End Sub

    Private Sub btnactualizar_Click(sender As Object, e As EventArgs) Handles btnactualizar.Click
        sentencia = "update propietarios set nombre_prop='" + txtnombre.Text + "',telefono_prop='" + txttelefono.Text + "'where id_propietarios='" + txtid.Text + "'"
        mensaje = "Datos Actualizados correctamente"
        EjecutarSql(sentencia, mensaje)
    End Sub

    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        sentencia = "delete from propietarios where id_propietarios='" + txtid.Text + "'"
